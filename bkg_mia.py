...
ntData = [  
            ...
            ("TT",      23640. , "../TTTo2L2Nu2B_8TeV_All.root"                  , ROOT.kBlack),
            ("ZZ",        784. , "../ZZJetsTo2L2Q_TuneZ2star_8TeV_All.root"      , ROOT.kGray),
            ("Signal",   72.81 , "../HToZZTo2L2Q_M-125_8TeV_PATtuple_WithPU.root", ROOT.kRed)   ]
lumi = 20.
